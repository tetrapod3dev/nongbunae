<template>
  <div class="nbn--font">
    <p class="sub_p mt-2">
      <span class="nbn--text-primary">1. 개인정보의 처리 목적</span>
      &lt;슬기로운재배생활&gt;(‘www.nongbunae.com’이하 ‘농부네텃밭’) 은(는)
    ...
    <p class="sub_p mt-2">
      ① &lt;슬기로운재배생활&gt;(‘www.nongbunae.com’이하 ‘농부네텃밭’) 은(는)
      정보주체로부터 개인정보를 수집할 때 동의 받은 개인정보 보유․이용기간 또는
    ...
    <p class="sub_p">
      (예시)- 고객 가입 및 관리 : 서비스 이용계약 또는 회원가입 해지시까지, 다만
    ...
    <p class="ls2">
      ① 정보주체는 슬기로운재배생활(‘www.nongbunae.com’이하 ‘농부네텃밭) 에 대해
    ...
    <p class="lh6 bs4">
      ...
      ①
      <em class="emphasis"
        >&lt;슬기로운재배생활&gt;('www.nongbunae.com'이하 '농부네텃밭')</em
      >은(는) 다음의 개인정보 항목을 처리하고 있습니다.
    </p>
    <ul class="list_indent2 mt-2">
      <li class="tt">1&lt;서비스 이용을 위한 정보 수집&gt;</li>
      <li>
        필수항목 : 이메일, 자택주소, 로그인ID, 서비스 이용 기록, 접속 로그,
        쿠키, 결제기록
      </li>
    </ul>
    <br />
    ...
    <p class="ls2">
      ...
      <br /><br />-파기기한<br />이용자의 개인정보는 개인정보의 보유기간이
      경과된 경우에는 보유기간의 종료일로부터 5일 이내에, 개인정보의 처리 목적
      달성, 해당 서비스의 폐지, 사업의 종료 등 그 개인정보가 불필요하게 되었을
      때에는 개인정보의 처리가 불필요한 것으로 인정되는 날로부터 5일 이내에 그
      개인정보를 파기합니다.
    </p>
    <p class="sub_p mt-2"></p>
    <br /><br />
    <p class="lh6 bs4">
      <strong
    ...
    <p class="ls2">
      ① 슬기로운재배생활 은 개별적인 맞춤서비스를 제공하기 위해 이용정보를
      저장하고 수시로 불러오는 ‘쿠기(cookie)’를 사용합니다. ② 쿠키는 웹사이트를
      ...
      상단의 도구>인터넷 옵션>개인정보 메뉴의 옵션 설정을 통해 쿠키 저장을 거부
      할 수 있습니다. 다. 쿠키 저장을 거부할 경우 맞춤형 서비스 이용에 어려움이
      발생할 수 있습니다.
    </p>

    <p class="sub_p mt-6"><strong>7. 개인정보 보호책임자 작성 </strong></p>
    <p class="sub_p mt-2">
      ①
      <span class="nbn--text-primary"
        >슬기로운재배생활(‘www.nongbunae.com’이하 ‘농부네텃밭)</span
      >
    ...
    <ul class="list_indent2 mt-2">
      ...
      <li>성명 :박태록</li>
      <li>연락처 :010-2550-5388, sdf7575@naver.com</li>
    </ul>
    ...
    <ul class="list_indent2 mt-2">
      ...
      <li>담당자 :박태록</li>
      <li>연락처 :010-2550-5388, ,</li>
    </ul>
    <p class="sub_p">
      ② 정보주체께서는 슬기로운재배생활(‘www.nongbunae.com’이하 ‘농부네텃밭) 의
      서비스(또는 사업)을 이용하시면서 발생한 모든 개인정보 보호 관련 문의,
      불만처리, 피해구제 등에 관한 사항을 개인정보 보호책임자 및 담당부서로
      문의하실 수 있습니다. 슬기로운재배생활(‘www.nongbunae.com’이하
      ‘농부네텃밭) 은(는) 정보주체의 문의에 대해 지체 없이 답변 및 처리해드릴
      것입니다.
    </p>
    <p class="sub_p mt-6"><strong>8. 개인정보 처리방침 변경 </strong></p>
    <p class="sub_p mt-2">
    ...
    <p class="lh6 bs4">
      <strong
        >9. 개인정보의 안전성 확보 조치
        <em class="emphasis">&lt;슬기로운재배생활>('농부네텃밭')</em>은(는)
        개인정보보호법 제29조에 따라 다음과 같이 안전성 확보에 필요한
        기술적/관리적 및 물리적 조치를 하고 있습니다.</strong
      >
    </p>
    <p class="sub_p mt-2">
      1. 개인정보의 암호화<br />
      ...
      기능을 사용하는 등의 별도 보안기능을 사용하고 있습니다. <br /><br />2.
      개인정보에 대한 접근 제한<br />
